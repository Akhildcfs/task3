...
Captured live network traffic while browsing websites.
Applied protocol-based filters such as TCP, DNS, HTTP, and HTTPS.
Observed the TCP three-way handshake process.
Identified plain-text (HTTP) and encrypted (HTTPS) traffic.
Captured and analyzed DNS queries.
Saved the packet capture file for analysis.
Documented observations in a structured analysis report.
📊 Observations
